...
const ICON_PATH = "res://assets/Kyrise_s 16x16 RPG Icon Pack - V1.2/icons/16x16/"
const WEAPON_PATH = "res://assets/Kyrise_s 16x16 RPG Icon Pack - V1.2/icons/16x16/"
const UPGRADES = {
	"icespear1": {
		"icon": WEAPON_PATH + "arrow_01c.png",
	...
	"tornado1": {
		"icon": WEAPON_PATH + "staff_03a.png",
		"displayname": "Tornado",
	...
	"drone1": {
		"icon": WEAPON_PATH + "book_01g.png",
		"displayname": "Drone",
		"details": "Spawn a drone that follows you and attacks enemies",
		"level": "Level: 1",
		"prerequisite": [],
		"type": "weapon"
	},
	"drone2": {
		"icon": WEAPON_PATH + "book_01g.png",
		"displayname": "Drone",
		"details": "Drones attack 50% faster",
		"level": "Level: 2",
		"prerequisite": ["drone1"],
		"type": "weapon"
	},
	"drone3": {
		"icon": WEAPON_PATH + "book_01g.png",
		"displayname": "Drone",
		"details": "Spawn an additional drone",
		"level": "Level: 3",
		"prerequisite": ["drone2"],
		"type": "weapon"
	},
